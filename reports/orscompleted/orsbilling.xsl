...
<xsl:if test="((/records/@username = 'lmerritt') and (((contains(billing_surgeon,'Achor') or contains(billing_surgeon,'Burgess') or contains(billing_surgeon,'Choo') or contains(billing_surgeon,'Harvin')) and (contains(routing_users,',lmerritt,')))
                                                      or ((contains(billing_surgeon2,'Achor') or contains(billing_surgeon2,'Burgess') or contains(billing_surgeon2,'Choo')or contains(billing_surgeon2,'Harvin')) and (contains(routing2_users,',lmerritt,')))
                                                      or ((contains(billing_surgeon3,'Achor') or contains(billing_surgeon3,'Burgess') or contains(billing_surgeon3,'Choo')or contains(billing_surgeon3,'Harvin')) and (contains(routing3_users,',lmerritt,')))
                                                      or ((contains(billing_surgeon4,'Achor') or contains(billing_surgeon4,'Burgess') or contains(billing_surgeon4,'Choo')or contains(billing_surgeon4,'Harvin')) and (contains(routing4_users,',lmerritt,')))
                                                      or ((contains(billing_surgeon5,'Achor') or contains(billing_surgeon5,'Burgess') or contains(billing_surgeon5,'Choo')or contains(billing_surgeon5,'Harvin')) and (contains(routing5_users,',lmerritt,')))
                                                      or ((contains(billing_surgeon6,'Achor') or contains(billing_surgeon6,'Burgess') or contains(billing_surgeon6,'Choo')or contains(billing_surgeon6,'Harvin')) and (contains(routing6_users,',lmerritt,')))
                                                      or ((contains(billing_surgeon7,'Achor') or contains(billing_surgeon7,'Burgess') or contains(billing_surgeon7,'Choo')or contains(billing_surgeon7,'Harvin')) and (contains(routing7_users,',lmerritt,')))
                                                      or ((contains(billing_surgeon8,'Achor') or contains(billing_surgeon8,'Burgess') or contains(billing_surgeon8,'Choo')or contains(billing_surgeon8,'Harvin')) and (contains(routing8_users,',lmerritt,')))
                                                      or ((contains(billing_surgeon9,'Achor') or contains(billing_surgeon9,'Burgess') or contains(billing_surgeon9,'Choo')or contains(billing_surgeon9,'Harvin')) and (contains(routing9_users,',lmerritt,')))
                                                      or ((contains(billing_surgeon10,'Achor') or contains(billing_surgeon10,'Burgess') or contains(billing_surgeon10,'Choo') or contains(billing_surgeon10,'Harvin')) and (contains(routing10_users,',lmerritt,'))))) or
                ((/records/@username = 'lstewart2') 
                          and (((contains(billing_surgeon,'Gary') or  contains(billing_surgeon,'Munz') or contains(billing_surgeon,'Prasarn') or contains(billing_surgeon,'Routt') or contains(billing_surgeon,'Tiffany')) and (contains(routing_users,',lstewart2,')))
                          or ((contains(billing_surgeon2,'Gary') or  contains(billing_surgeon2,'Munz') or contains(billing_surgeon2,'Prasarn') or contains(billing_surgeon2,'Routt') or contains(billing_surgeon2,'Tiffany')) and (contains(routing2_users,',lstewart2,')))
                          or ((contains(billing_surgeon3,'Gary') or  contains(billing_surgeon3,'Munz') or contains(billing_surgeon3,'Prasarn') or contains(billing_surgeon3,'Routt') or contains(billing_surgeon3,'Tiffany')) and (contains(routing3_users,',lstewart2,')))
                          or ((contains(billing_surgeon4,'Gary') or  contains(billing_surgeon4,'Munz') or contains(billing_surgeon4,'Prasarn') or contains(billing_surgeon4,'Routt') or contains(billing_surgeon4,'Tiffany')) and (contains(routing4_users,',lstewart2,')))
                          or ((contains(billing_surgeon5,'Gary') or  contains(billing_surgeon5,'Munz') or contains(billing_surgeon5,'Prasarn') or contains(billing_surgeon5,'Routt') or contains(billing_surgeon5,'Tiffany')) and (contains(routing5_users,',lstewart2,')))
                          or ((contains(billing_surgeon6,'Gary') or  contains(billing_surgeon6,'Munz') or contains(billing_surgeon6,'Prasarn') or contains(billing_surgeon6,'Routt') or contains(billing_surgeon6,'Tiffany')) and (contains(routing6_users,',lstewart2,')))
                          or ((contains(billing_surgeon7,'Gary') or  contains(billing_surgeon7,'Munz') or contains(billing_surgeon7,'Prasarn') or contains(billing_surgeon7,'Routt') or contains(billing_surgeon7,'Tiffany')) and (contains(routing7_users,',lstewart2,')))
                          or ((contains(billing_surgeon8,'Gary') or  contains(billing_surgeon8,'Munz') or contains(billing_surgeon8,'Prasarn') or contains(billing_surgeon8,'Routt') or contains(billing_surgeon8,'Tiffany')) and (contains(routing8_users,',lstewart2,')))
                          or ((contains(billing_surgeon9,'Gary') or  contains(billing_surgeon9,'Munz') or contains(billing_surgeon9,'Prasarn') or contains(billing_surgeon9,'Routt') or contains(billing_surgeon9,'Tiffany')) and (contains(routing9_users,',lstewart2,')))
                          or ((contains(billing_surgeon10,'Gary') or  contains(billing_surgeon10,'Munz') or contains(billing_surgeon10,'Prasarn') or contains(billing_surgeon10,'Routt') or contains(billing_surgeon10,'Tiffany')) and (contains(routing10_users,',lstewart2,')))))
