...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match ="/">
        ...
        <html class="no-js" lang="en" >
            <head>
                ...
                <!--<link rel="stylesheet" href="css/orslegacy.css" media="screen"/>-->
                ...
                <script>
                    /*** CHANGE THIS ***/
                    var projectId = '87';
                    var redcapVersionString = 'redcap_v6.15.8';
                    var consultationEv = '699';
                    var surgery1Ev = '720';
                    var surgery2Ev = '721';
                    var surgery3Ev = '722';
                    var surgery4Ev = '723';
                    var surgery5Ev = '724';
                    /*******************/
                    var dataEntryPage = '/'+redcapVersionString+'/DataEntry/index.php';
                    ...
                    {
                    var xmlhttp;
                    var pageToDisplay = 'reports/orsbilling/setup.php?pid='+projectId;
                    ...
                    <div class="content active" id="userpanel">
                      ...
                      -->
                        <form>
                            ...
                            <xsl:if test="records/@username = 'lmerritt'">
                                <fieldset style="background-color:#D0DBF7;">
                                    <legend><xsl:value-of select="/records/@username"/></legend>
                                    <xsl:apply-templates select="/records/item[routing_users = ',lmerritt,'] |
                /records/item[routing2_users = ',lmerritt,'] |
                /records/item[routing3_users = ',lmerritt,'] |
                /records/item[routing4_users = ',lmerritt,'] |
                /records/item[routing5_users = ',lmerritt,'] |
                /records/item[routing6_users = ',lmerritt,'] |
                /records/item[routing7_users = ',lmerritt,'] |
                /records/item[routing8_users = ',lmerritt,'] |
                /records/item[routing9_users = ',lmerritt,'] |
                /records/item[routing10_users = ',lmerritt,'] " mode="personal">
                            ...
                            <xsl:if test="records/@username = 'lmerritt'">
                                <fieldset style="background-color:#F5E5CB;">
                                    <legend><xsl:value-of select="/records/@username"/></legend>
                                    <xsl:apply-templates select="/records/item[contains(routing_record_users, ',dataentry,')]" mode="personal2">
                                        <xsl:sort select="translate(translate(patient_last, 'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ'),' ','')" order="ascending" />
                                    </xsl:apply-templates>
                                </fieldset>
                            </xsl:if>
                            ...
                            <xsl:if test="records/@username != 'lmerritt'">
                                <fieldset style="background-color:#F5E5CB;">
                                    <legend><xsl:value-of select="/records/@username"/></legend>
                                    <xsl:apply-templates select="/records/item[contains(routing_record_users,concat(',',/records/@username,','))]" mode="personal2">
                                        <xsl:sort select="translate(translate(patient_last, 'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ'),' ','')" order="ascending" />
                                    </xsl:apply-templates>
                                </fieldset>
                            </xsl:if>
    ...
    <xsl:template match="item" mode="summary">
        <div class="demo small-12 medium-12 large-3 column">
            <span class="dlabel">Patient: </span>
            <span>
            ...
            <span class="dlabel">Consultation: </span><span><xsl:value-of select="billing_consult"/></span><br/>
    ...
    <xsl:template match="item" mode="personal">
        ...
        <fieldset class="record" style="background-color:white;">
            ...
            <div class="record rows">
                ...
                <div class="billinfo small-12 medium-12 large-6 column">
                    <table class="bills">
                        <tr>
                            <th style="text-align:center;" width="20">#</th>
                            <th width="100px" style="text-align:center"><span class="dlabel">Date of Service</span></th><th width="100px" style="text-align:center"><span class="tablegreentext dlabel">Received by Billing</span></th><th width="150px" style="text-align:center"><span class="pink dlabel">Completed by CODING</span></th><th width="100px" style="text-align:center"><span class="redtext dlabel">Finished by Billing</span></th><th width="150px" style="text-align:center"><span class="dlabel">Surgeon</span></th><th><span class="dlabel">Location</span></th>
                        </tr>
                        ...
                        <xsl:if test="contains(routing_users,concat(',',/records/@username,','))">
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:choose>
                                        <xsl:when test="site = 1">Southwest</xsl:when>
                                        <xsl:when test="site = 2">Northwest</xsl:when>
                                        <xsl:when test="site = 3">Texas Medical Center</xsl:when>
                                        <xsl:when test="site = 4">Memorial City</xsl:when>
                                        <xsl:when test="site = 5">HOSH</xsl:when>
                                        <xsl:when test="site = 6">TMC Surgery Center</xsl:when>
                                        <xsl:when test="site = 7">LBJ</xsl:when>
                                        <xsl:when test="site = 8">TIRR</xsl:when>
                                        <xsl:otherwise>No location indicated</xsl:otherwise>
                                    </xsl:choose>
                                </td>
                            </tr>
                        </xsl:if>
            ...
            <div class="rows">
                ...
                <div class="small-12 medium-12 large-8 column">
                    <xsl:if test="redcap_event_name = 'consultation_arm_1'">
                        <button class="tiny button" type="button" onclick="window.open(dataEntryPage+'?pid='+projectId+'&amp;id={registry_id}&amp;event_id='+consultationEv+'&amp;page=billing');">Edit</button>
                    </xsl:if>
                    <xsl:if test="redcap_event_name = 'surgery_1_arm_1'">
                        <button class="tiny button" type="button" onclick="window.open(dataEntryPage+'?pid='+projectId+'&amp;id={registry_id}&amp;event_id='+surgery1Ev+'&amp;page=billing');">Edit</button>
                    </xsl:if>
                    <xsl:if test="redcap_event_name = 'surgery_2_arm_1'">
                        <button class="tiny button" type="button" onclick="window.open(dataEntryPage+'?pid='+projectId+'&amp;id={registry_id}&amp;event_id='+surgery2Ev+'&amp;page=billing');">Edit</button>
                    </xsl:if>
                    <xsl:if test="redcap_event_name = 'surgery_3_arm_1'">
                        <button class="tiny button" type="button" onclick="window.open(dataEntryPage+'?pid='+projectId+'&amp;id={registry_id}&amp;event_id='+surgery3Ev+'&amp;page=billing');">Edit</button>
                    </xsl:if>
                    <xsl:if test="redcap_event_name = 'surgery_4_arm_1'">
                        <button class="tiny button" type="button" onclick="window.open(dataEntryPage+'?pid='+projectId+'&amp;id={registry_id}&amp;event_id='+surgery4Ev+'&amp;page=billing');">Edit</button>
                    </xsl:if>
                    <xsl:if test="redcap_event_name = 'surgery_5_arm_1'">
                        <button class="tiny button" type="button" onclick="window.open(dataEntryPage+'?pid='+projectId+'&amp;id={registry_id}&amp;event_id='+surgery5Ev+'&amp;page=billing');">Edit</button>
                    </xsl:if>
                </div>
            </div>
        </fieldset>
    ...
    <xsl:template match="item" mode="personal2">
        <!--
                    ...
                    <table class="bills">
                        <tr>
                            ...
                            <th width="100px" style="text-align:center">
                                <span class="dlabel">Date of Admission</span>
                            </th>

                            <th width="100px" style="text-align:center"><span class="dlabel">Date of Service</span></th><th width="100px" style="text-align:center"><span class="tablegreentext dlabel">Received by Billing</span></th><th width="150px" style="text-align:center"><span class="pink dlabel">Completed by CODING</span></th><th width="100px" style="text-align:center"><span class="redtext dlabel">Finished by Billing</span></th><th width="150px" style="text-align:center"><span class="dlabel">Surgeon</span></th><th style="text-align:center"><span class="dlabel">Location</span></th>
                        </tr>
                        ...
                        <xsl:if test="contains(routing_users,concat(',',/records/@username,','))">
                            ...
                            <tr>
                                <td><span>1</span></td>
                                <td><span><xsl:value-of select="billing_admit"/></span></td>
                                <td><span><xsl:value-of select="billing_date"/></span></td>
                                <td><span><xsl:value-of select="billing_date_rec"/></span></td>
                                <td><span><xsl:value-of select="billing_date_cod"/></span></td>
                                <td><span><xsl:value-of select="billing_date_end"/></span></td>
                        ...
                        <xsl:if test="contains(routing2_users,concat(',',/records/@username,','))">
                            <tr>
                                <td><span>2</span></td>
                                <td><span><xsl:value-of select="billing_admit2"/></span></td>
                                <td><span><xsl:value-of select="billing_date2"/></span></td>
                                <td><span><xsl:value-of select="billing_date_rec2"/></span></td>
                                <td><span><xsl:value-of select="billing_date_cod2"/></span></td>
                                <td><span><xsl:value-of select="billing_date_end2"/></span></td>
                                ...
                                <td>
                                    <xsl:choose>
                                        <xsl:when test="site2 = 1">Southwest</xsl:when>
                                        <xsl:when test="site2 = 2">Northwest</xsl:when>
                                        <xsl:when test="site2 = 3">Texas Medical Center</xsl:when>
                                        <xsl:when test="site2 = 4">Memorial City</xsl:when>
                                        <xsl:when test="site2 = 5">HOSH</xsl:when>
                                        <xsl:when test="site2 = 6">TMC Surgery Center</xsl:when>
                                        <xsl:when test="site2 = 7">LBJ</xsl:when>
                                        <xsl:when test="site2 = 8">TIRR</xsl:when>
                                        <xsl:otherwise>No location indicated</xsl:otherwise>
                                    </xsl:choose>
                                </td>
                            </tr>
                        ...
                        <xsl:if test="contains(routing3_users,concat(',',/records/@username,','))">
                            <tr>
                                <td><span>3</span></td>
                                <td><span><xsl:value-of select="billing_admit3"/></span></td>
                                <td><span><xsl:value-of select="billing_date3"/></span></td>
                                <td><span><xsl:value-of select="billing_date_rec3"/></span></td>
                                <td><span><xsl:value-of select="billing_date_cod3"/></span></td>
                                <td><span><xsl:value-of select="billing_date_end3"/></span></td>
                                ...
                                <td>
                                    <xsl:choose>
                                        <xsl:when test="site3 = 1">Southwest</xsl:when>
                                        <xsl:when test="site3 = 2">Northwest</xsl:when>
                                        <xsl:when test="site3 = 3">Texas Medical Center</xsl:when>
                                        <xsl:when test="site3 = 4">Memorial City</xsl:when>
                                        <xsl:when test="site3 = 5">HOSH</xsl:when>
                                        <xsl:when test="site3 = 6">TMC Surgery Center</xsl:when>
                                        <xsl:when test="site3 = 7">LBJ</xsl:when>
                                        <xsl:when test="site3 = 8">TIRR</xsl:when>
                                        <xsl:otherwise>No location indicated</xsl:otherwise>
                                    </xsl:choose>
                                </td>
                            </tr>
                        ...
                        <xsl:if test="contains(routing4_users,concat(',',/records/@username,','))">
                            <tr>
                                <td><span>4</span></td>
                                <td><span><xsl:value-of select="billing_admit4"/></span></td>
                                <td><span><xsl:value-of select="billing_date4"/></span></td>
                                <td><span><xsl:value-of select="billing_date_rec4"/></span></td>
                                <td><span><xsl:value-of select="billing_date_cod4"/></span></td>
                                <td><span><xsl:value-of select="billing_date_end4"/></span></td>
                                ...
                                <td>
                                    <xsl:choose>
                                        <xsl:when test="site4 = 1">Southwest</xsl:when>
                                        <xsl:when test="site4 = 2">Northwest</xsl:when>
                                        <xsl:when test="site4 = 3">Texas Medical Center</xsl:when>
                                        <xsl:when test="site4 = 4">Memorial City</xsl:when>
                                        <xsl:when test="site4 = 5">HOSH</xsl:when>
                                        <xsl:when test="site4 = 6">TMC Surgery Center</xsl:when>
                                        <xsl:when test="site4 = 7">LBJ</xsl:when>
                                        <xsl:when test="site4 = 8">TIRR</xsl:when>
                                        <xsl:otherwise>No location indicated</xsl:otherwise>
                                    </xsl:choose>
                                </td>
                            </tr>
                        ...
                        <xsl:if test="contains(routing5_users,concat(',',/records/@username,','))">
                            <tr>
                                <td><span>5</span></td>
                                <td><span><xsl:value-of select="billing_admit5"/></span></td>
                                <td><span><xsl:value-of select="billing_date5"/></span></td>
                                <td><span><xsl:value-of select="billing_date_rec5"/></span></td>
                                <td><span><xsl:value-of select="billing_date_cod5"/></span></td>
                                <td><span><xsl:value-of select="billing_date_end5"/></span></td>
                                ...
                                <td>
                                    <xsl:choose>
                                        <xsl:when test="site5 = 1">Southwest</xsl:when>
                                        <xsl:when test="site5 = 2">Northwest</xsl:when>
                                        <xsl:when test="site5 = 3">Texas Medical Center</xsl:when>
                                        <xsl:when test="site5 = 4">Memorial City</xsl:when>
                                        <xsl:when test="site5 = 5">HOSH</xsl:when>
                                        <xsl:when test="site5 = 6">TMC Surgery Center</xsl:when>
                                        <xsl:when test="site5 = 7">LBJ</xsl:when>
                                        <xsl:when test="site5 = 8">TIRR</xsl:when>
                                        <xsl:otherwise>No location indicated</xsl:otherwise>
                                    </xsl:choose>
                                </td>
                            </tr>
                        ...
                        <xsl:if test="contains(routing6_users,concat(',',/records/@username,','))">
                            <tr>
                                <td><span>6</span></td>
                                <td><span><xsl:value-of select="billing_admit6"/></span></td>
                                <td><span><xsl:value-of select="billing_date6"/></span></td>
                                <td><span><xsl:value-of select="billing_date_rec6"/></span></td>
                                <td><span><xsl:value-of select="billing_date_cod6"/></span></td>
                                <td><span><xsl:value-of select="billing_date_end6"/></span></td>
                                ...
                                <td>
                                    <xsl:choose>
                                        <xsl:when test="site6 = 1">Southwest</xsl:when>
                                        <xsl:when test="site6 = 2">Northwest</xsl:when>
                                        <xsl:when test="site6 = 3">Texas Medical Center</xsl:when>
                                        <xsl:when test="site6 = 4">Memorial City</xsl:when>
                                        <xsl:when test="site6 = 5">HOSH</xsl:when>
                                        <xsl:when test="site6 = 6">TMC Surgery Center</xsl:when>
                                        <xsl:when test="site6 = 7">LBJ</xsl:when>
                                        <xsl:when test="site6 = 8">TIRR</xsl:when>
                                        <xsl:otherwise>No location indicated</xsl:otherwise>
                                    </xsl:choose>
                                </td>
                            </tr>
                ...
                <div class="small-12 medium-12 large-8 column">
                    <table class="bills">
                        <tr>
                            ...
                            <th width="100px" style="text-align:center"><span class="dlabel">Date of Service</span></th>
                            <th width="100px" style="text-align:center"><span class="tablegreentext dlabel">Received by Billing</span></th><th width="150px" style="text-align:center"><span class="pink dlabel">Completed by CODING</span></th><th width="100px" style="text-align:center"><span class="redtext dlabel">Finished by Billing</span></th><th style="text-align:center" width="150px"><span class="dlabel">Surgeon</span></th><th style="text-align:center"><span class="dlabel">Location</span></th>
                        </tr>
                ...
                <div class="small-12 medium-12 large-9 column">
                    <table class="bills">
                        <tr>
                            ...
                            <th width="100px" style="text-align:center">
                                <span class="dlabel">Date of Service</span>
                            </th><th width="130px" style="text-align:center"><span class="tablegreentext dlabel">Received by Billing</span></th><th width="150px" style="text-align:center"><span class="pink dlabel">Completed by CODING</span></th><th width="130px" style="text-align:center"><span class="redtext dlabel">Finished by Billing</span></th><th width="150px" style="text-align:center"><span class="dlabel">Surgeon</span></th><th width="150px" style="text-align:center"><span class="dlabel">For</span></th>
                            <th style="text-align:center"><span class="dlabel">Location</span></th>
                        </tr>
