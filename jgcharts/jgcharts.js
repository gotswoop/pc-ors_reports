...
// Changes made
/* remove chxt and chxl (axis_type and axis_labels)
add chdl and chdlp=b
show legend even if pie chart
add fake series for pie charts too
*/
...
jGCharts.Api = function(){
    ...
    function _color(){
        ...
        // add color (fake serie) + FIX for pie charts
        if((_is_fillarea && _filltop) || _is_pie)
            i++;
    ...
    function _options(options){
    	...
    	if(options.legend_pos)
    		_legend_pos = options.legend_pos;
    ...
    return {
        ...
        make    :   function(options){
			...
			url += _param("legend_pos", _legend_pos);
